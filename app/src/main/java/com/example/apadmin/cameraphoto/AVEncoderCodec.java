...
//
//import com.codec.CodecProvider;
...
//    private CodecProvider aEncoder;                // API >= 16(Android4.1.2)
...
//    private AVEncoder.Callback mCallback;
//
//    public static AVEncoderCodec newInstance() {
//        return new AVEncoderCodec();
//    }
//
//    private AVEncoderCodec() {
//    }
//
//    /**
//     * 设置回调
...
//     * @param callback 回调
//     */
//    public void setCallback(AVEncoder.Callback callback) {
...
//        aEncoder = new CodecProvider();
//        int bitRate = sampleRate * pcmFormat * chanelCount;
//        aEncoder.buildCodec(INative.CodecType.OPUS,sampleRate,chanelCount,bitRate);
////        aBufferInfo = new MediaCodec.BufferInfo();
////        audioQueue = new LinkedBlockingQueue<>();
////        audioCodecInfo = selectCodec(AUDIO_MIME_TYPE);
////        if (audioCodecInfo == null) {
////            if (DEBUG)
////                Log.e(TAG, "=====zhongjihao====Unable to find an appropriate codec for " + AUDIO_MIME_TYPE);
////            return;
////        }
...
//                        byte[] result = aEncoder.encode(data);
//                        if (null != result) {
//                            ByteBuffer inputBuffer = ByteBuffer.allocate(result.length);
//                            inputBuffer.put(result);
//                            if (null != mCallback && !aEncoderEnd) {
//                                mCallback.outputAudioFrame(AVmediaMuxer.TRACK_AUDIO, inputBuffer, null);
//                            }
//                        }
//                    } catch (InterruptedException e) {
//                        e.printStackTrace();
...
////            if (inputBufferIndex >= 0) { //输入缓冲区有效
////                if (DEBUG)
////                    Log.d(TAG, "======zhongjihao====Audio===inputBufferIndex: " + inputBufferIndex);
////                ByteBuffer inputBuffer = inputBuffers[inputBufferIndex];
////                inputBuffer.clear();
////                //往输入缓冲区写入数据
